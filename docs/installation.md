...
- **Java:** Java 21 or newer (Minecraft 1.21.10 requirement)
...
2. Run the installer
3. Select **Minecraft 1.21.10** 
4. Select **Fabric Loader** 0.17.3
5. Click "Install"
...
4. Select version: **fabric-loader-0.17.3-1.21.10** 
5. Name it "DAGMod v1.4.4-beta"
6. Click "Create"

### Step 2: Install Fabric API

1. Download **Fabric API 0.138.0+1.21.10** from:
...
1. Download **DAGMod v1.5.0-beta** from:
...
1. Open the Minecraft Launcher
2. Select the **Fabric Loader 1.21.10** profile (or "DAGMod v1.5.0-beta" if you named it)
3. Click "Play"
...
1. Start Minecraft with the same mods (Fabric API + DAGMod v1.4.4-beta)
2. Go to "Multiplayer"
3. Click "Add Server"
...
3. DAGMod v1.5.0-beta should appear in the list
...
- **Solution:** Install Fabric API [LATEST] for Minecraft 1.21.x
...
- **Solution:**
  - Ensure both client and server have DAGMod v1.4.4-beta
...
3. **Download DAGMod v1.5.0-beta** (or newer)
...
4. **Add new DAGMod v1.5.0-beta `.jar`** to mods folder
5. **Start the server**
...
### Current Configuration (v1.4.4-beta)
...
2. Delete `DAGMod-1.5.0-beta.jar`
3. Launch Minecraft

**Server:**
1. Stop the server
2. Navigate to server `mods` folder
3. Delete `DAGMod-1.4.4-beta.jar`
4. Restart server
