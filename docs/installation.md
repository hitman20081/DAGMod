...
See [CHANGELOG.md](https://github.com/hitman20081/DAGMod/blob/main/CHANGELOG.md) for the full version history.
...
1. Download the **latest DAGMod release** from:
...
1. Download the **latest DAGMod release**
...
1. Start Minecraft with the same mods (Fabric API + DAGMod)
2. Go to "Multiplayer"
3. Click "Add Server"
...
3. DAGMod should appear in the list
...
- **Solution:**
  - Ensure both client and server have the same version of DAGMod
...
3. **Download the latest DAGMod release**
...
4. **Add the new DAGMod `.jar`** to mods folder
5. **Start the server**
...
**Q: Where can I see what's new in each update?**
A: See the [CHANGELOG](https://github.com/hitman20081/DAGMod/blob/main/CHANGELOG.md) for the full version history.
...
- Explore [Progression](link) for the level 1-200 system
