...
execute as @e[type=chest_minecart,tag=new] run function dagmod:menu/demo/root/open
execute as @e[type=chest_minecart,tag=new] run function dagmod:minecart/load_page
