...
give @s chest[lock={id:"minecraft:ominous_trial_key",count:1,components:{"minecraft:item_name":'{"color":"red","text":"Custom Key"}'}},item_name='{"color":"red","text":"Custom Chest"}',container_loot={loot_table:"dagmod:chests/world_loot"}] 1
