...
execute as @e[type=chest_minecart,tag=new] run function dag020:menu/demo/root/open
execute as @e[type=chest_minecart,tag=new] run function dag020:minecart/load_page
