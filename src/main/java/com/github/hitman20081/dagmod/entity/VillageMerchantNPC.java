...
public class VillageMerchantNPC extends PathAwareEntity {
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        if (!this.getEntityWorld().isClient()) {
            player.sendMessage(Text.literal("<Village Merchant> Welcome to our village! Please, have a look."), false);
        }
