...
public class RotatingTradeRegistry {
    ...
    private static final Map<MerchantType, List<List<MerchantOffer>>> ROTATING_TRADES = new EnumMap<>(MerchantType.class);
    ...
    private static void initializeArmorerTrades() {
        List<List<MerchantOffer>> rotations = new ArrayList<>();

        // Rotation 0: Dragonscale Armor
        rotations.add(Arrays.asList(
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_SILVER, 12),
                        Optional.of(new ItemCost(ModItems.DRAGON_SCALE, 5)),
                        new ItemStack(ModItems.DRAGONSCALE_HELMET),
                        1, 20, 0.05F
                ),
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_SILVER, 16),
                        Optional.of(new ItemCost(ModItems.DRAGON_SCALE, 8)),
                        new ItemStack(ModItems.DRAGONSCALE_CHESTPLATE),
                        1, 20, 0.05F
                ),
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_SILVER, 14),
                        Optional.of(new ItemCost(ModItems.DRAGON_SCALE, 7)),
                        new ItemStack(ModItems.DRAGONSCALE_LEGGINGS),
                        1, 20, 0.05F
                ),
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_SILVER, 10),
        ...
        rotations.add(Arrays.asList(
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_SILVER, 10),
                        Optional.of(new ItemCost(Items.BLAZE_ROD, 6)),
                        new ItemStack(ModItems.INFERNO_HELMET),
                        1, 18, 0.05F
                ),
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_SILVER, 14),
                        Optional.of(new ItemCost(Items.BLAZE_ROD, 10)),
                        new ItemStack(ModItems.INFERNO_CHESTPLATE),
                        1, 18, 0.05F
                ),
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_SILVER, 12),
                        Optional.of(new ItemCost(Items.BLAZE_ROD, 8)),
                        new ItemStack(ModItems.INFERNO_LEGGINGS),
                        1, 18, 0.05F
                ),
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_SILVER, 8),
                        Optional.of(new ItemCost(Items.BLAZE_ROD, 5)),
        ...
        rotations.add(Arrays.asList(
                ...
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_SILVER, 14),
                        Optional.of(new ItemCost(Items.AMETHYST_SHARD, 24)),
                        new ItemStack(ModItems.CRYSTALFORGE_CHESTPLATE),
                        1, 18, 0.05F
                ),
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_SILVER, 12),
                        Optional.of(new ItemCost(Items.AMETHYST_SHARD, 20)),
                        new ItemStack(ModItems.CRYSTALFORGE_LEGGINGS),
                        1, 18, 0.05F
                ),
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_SILVER, 8),
                        Optional.of(new ItemCost(Items.AMETHYST_SHARD, 12)),
        ...
        rotations.add(Arrays.asList(
                ...
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_COPPER, 48),
                        Optional.of(new ItemCost(Items.ECHO_SHARD, 6)),
                        new ItemStack(ModItems.SHADOW_CHESTPLATE),
                        1, 15, 0.05F
                ),
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_COPPER, 44),
                        Optional.of(new ItemCost(Items.ECHO_SHARD, 5)),
                        new ItemStack(ModItems.SHADOW_LEGGINGS),
                        1, 15, 0.05F
                ),
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_COPPER, 28),
                        Optional.of(new ItemCost(Items.ECHO_SHARD, 3)),
        ...
        rotations.add(Arrays.asList(
                ...
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_SILVER, 12),
                        Optional.of(new ItemCost(Items.BLUE_ICE, 12)),
                        new ItemStack(ModItems.FROSTBOUND_CHESTPLATE),
                        1, 16, 0.05F
                ),
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_SILVER, 10),
                        Optional.of(new ItemCost(Items.BLUE_ICE, 10)),
                        new ItemStack(ModItems.FROSTBOUND_LEGGINGS),
                        1, 16, 0.05F
                ),
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_SILVER, 6),
                        Optional.of(new ItemCost(Items.BLUE_ICE, 6)),
        ...
        rotations.add(Arrays.asList(
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_COPPER, 28),
                        Optional.of(new ItemCost(Items.SUNFLOWER, 8)),
                        new ItemStack(ModItems.SOLARWEAVE_HELMET),
                        1, 15, 0.05F
                ),
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_COPPER, 40),
                        Optional.of(new ItemCost(Items.SUNFLOWER, 12)),
                        new ItemStack(ModItems.SOLARWEAVE_CHESTPLATE),
                        1, 15, 0.05F
                ),
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_COPPER, 36),
                        Optional.of(new ItemCost(Items.SUNFLOWER, 10)),
                        new ItemStack(ModItems.SOLARWEAVE_LEGGINGS),
                        1, 15, 0.05F
                ),
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_COPPER, 24),
                        Optional.of(new ItemCost(Items.SUNFLOWER, 6)),
    ...
    private static void initializeMysteryMerchantTrades() {
        ...
        rotations.add(Arrays.asList(
                ...
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_COPPER, 52),
        ...
        rotations.add(Arrays.asList(
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_COPPER, 48),
                        Optional.of(new ItemCost(ModItems.DRAGON_SCALE, 2)),
                        new ItemStack(ModItems.DRAGONSCALE_SWORD),
                        1, 18, 0.05F
                ),
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_SILVER, 16),
                        Optional.of(new ItemCost(ModItems.DRAGON_BONE, 4)),
                        new ItemStack(ModItems.DRAGONBONE_SHIELD),
                        1, 22, 0.05F
                ),
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_SILVER, 20),
                        Optional.of(new ItemCost(ModItems.DRAGON_SCALE, 4)),
                        new ItemStack(ModItems.DRAGONSCALE_SWORD),
                        1, 22, 0.05F
                )
        ...
        rotations.add(Arrays.asList(
                ...
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_COPPER, 56),
                        Optional.of(new ItemCost(Items.BLUE_ICE, 16)),
                        new ItemStack(ModItems.FROSTBITE_AXE),
                        1, 18, 0.05F
                ),
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_SILVER, 20),
                        Optional.of(new ItemCost(Items.TRIDENT, 1)),
        ...
        rotations.add(Arrays.asList(
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_SILVER, 24),
                        Optional.of(new ItemCost(Items.NETHER_STAR, 1)),
                        new ItemStack(ModItems.ETHEREAL_BLADE),
                        1, 25, 0.05F
                ),
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_SILVER, 28),
                        Optional.of(new ItemCost(ModItems.SILMARIL, 1)),
                        new ItemStack(ModItems.CRYSTALHAMMER),
                        1, 28, 0.05F
                ),
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_SILVER, 16),
                        Optional.of(new ItemCost(Items.GHAST_TEAR, 4)),
    ...
    private static MerchantOffer createEnchantedBookPlaceholder(String name, int emeraldCost, int maxUses, int xp) {
        return new MerchantOffer(
                new ItemCost(ModItems.COIN_COPPER, emeraldCost),
    ...
    private static void initializeTrophyDealerTrades() {
        ...
        rotations.add(Arrays.asList(
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_SILVER, 32),
                        Optional.of(new ItemCost(Items.NETHER_STAR, 1)),
                        new ItemStack(ModItems.DRAGON_HEART),
                        1, 50, 0.05F
                ),
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_SILVER, 64),
        ...
        rotations.add(Arrays.asList(
                ...
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_SILVER, 48),
    ...
    private static void initializeMinerTrades() {
        ...
        rotations.add(Arrays.asList(
                ...
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_COPPER, 7),
                        Optional.empty(),
    ...
    private static void initializeHunterTrades() {
        ...
        rotations.add(Arrays.asList(
                ...
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_COPPER, 24),
                        Optional.of(new ItemCost(Items.GOLD_INGOT, 8)),
        ...
        rotations.add(Arrays.asList(
                new MerchantOffer(
                        new ItemCost(ModItems.COIN_COPPER, 6),
                        Optional.of(new ItemCost(Items.GLOWSTONE_DUST, 8)),
    ...
    public static int getRotationCount(MerchantType type) {
        List<List<MerchantOffer>> rotations = ROTATING_TRADES.get(type);
     ...
     */
    public static List<MerchantOffer> getRotatingTrades(MerchantType type, int rotationIndex) {
        List<List<MerchantOffer>> rotations = ROTATING_TRADES.get(type);
