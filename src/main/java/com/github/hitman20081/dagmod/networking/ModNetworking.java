...
public class ModNetworking {
    ...
    public static final Identifier QUEST_SYNC_ID = Identifier.fromNamespaceAndPath(DagMod.MOD_ID, "quest_sync");
    public static final Identifier QUEST_REQUEST_ID = Identifier.fromNamespaceAndPath(DagMod.MOD_ID, "quest_request");

    public static void registerC2SPackets() {
        // Client to Server packets
        PayloadTypeRegistry.serverboundPlay().register(QuestRequestPacket.ID, QuestRequestPacket.CODEC);
    ...
    public static void registerS2CPackets() {
        ...
        PayloadTypeRegistry.clientboundPlay().register(QuestSyncPacket.ID, QuestSyncPacket.CODEC);
    }
