...
public class GemInfusingStationBlock extends BlockWithEntity {
    public static final MapCodec<GemInfusingStationBlock> CODEC = createCodec(GemInfusingStationBlock::new);
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        ...
        return validateTicker(type, com.github.hitman20081.dagmod.block.entity.ModBlockEntities.GEM_INFUSING_STATION,
